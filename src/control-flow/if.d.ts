...
export type IfElseIf<
  ...
  [[Condition: unknown, Result: unknown], ...[Condition: unknown, Result: unknown][], unknown]
> = A extends readonly [infer IfExpression, ...infer ElseIfExpressions, infer ElseResult]
    ...
    ? If<
        ...
        If<
          ...
          ElseIfExpressions extends [
            ...
            ? OtherElseIfExpressions extends [Condition: unknown, Result: unknown][]
              ? IfElseIf<[[ElseIfCondition, ElseIfResult], ...OtherElseIfExpressions, ElseResult]>
              : If<ElseIfCondition, ElseIfResult, ElseResult>
            : ElseResult,
          // empty array or array
          ElseIfExpressions extends [infer ElseIfCondition, infer ElseIfResult][]
            ? If<ElseIfCondition, ElseIfResult, ElseResult>
            : ElseResult
        >
      >
