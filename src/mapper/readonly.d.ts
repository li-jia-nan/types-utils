...
/**
  ...
  * ```
  */
export type SetReadonly<T, K extends Keys<T>> = Simplify<StrictOmit<T, K> & Readonly<Pick<T, K>>>;
...
export type ReadonlyKeys<T> = {
  ...
  [K in keyof T]-?: If<IsEquals<{ [P in K]: T[P] }, { -readonly [P in K]: T[P] }>, never, K>;
}[Keys<T>];
...
/**
  ...
  * ```
  */
export type SetReadonlyDeep<T, K extends DeepKeys<T>> = IsNever<Extract<K, Keys<T>>> extends true
