 ...
 * ```
 */
export type setMutable<T, K extends Keys<T>> = Simplify<StrictOmit<T, K> & Mutable<Pick<T, K>>>;
...
/**
  ...
  * ```
  */
export type setMutableDeepPick<T, K extends DeepKeys<T>> = IsNever<Extract<K, Keys<T>>> extends true
