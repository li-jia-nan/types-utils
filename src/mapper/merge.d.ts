 ...
 *
 */
export type MergeTuple<A extends readonly unknown[], B extends readonly unknown[]> = If<
  IsReadonlyArray<B>,
    ...
    ? B[0] extends infer V
      ? V extends V
        ? InternalDeepMergeTupleValue<
            RestA,
            RestB,
            [...Result, If<And<[IsObject<V>, IsObject<A[0]>]>, DeepMerge<A[0], V>, V>]
          >
        : never
      : never
    : [...Result, ...B]
 ...
 * ```
 */
export type DeepMergeTuple<A extends readonly unknown[], B extends readonly unknown[]> = If<
  IsReadonlyArray<B>,
